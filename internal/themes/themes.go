...
var defaultTheme = Theme{
	...
	lineActionColors: map[grid.Action]string{
		...
		grid.ActionSpecificValue: "#f564a9",
		grid.ActionTempoChange:   "#5cdffb",
	},
}
...
var seafoamTheme = Theme{
	...
	lineActionColors: map[grid.Action]string{
		...
		grid.ActionSpecificValue: "#ffd166",
		grid.ActionTempoChange:   "#1a8fe3",
	},
}
...
var dynamiteTheme = Theme{
	...
	lineActionColors: map[grid.Action]string{
		...
		grid.ActionSpecificValue: "#d81b60",
		grid.ActionTempoChange:   "#00e5ff",
	},
}
...
var springtimeTheme = Theme{
	...
	lineActionColors: map[grid.Action]string{
		...
		grid.ActionSpecificValue: "#ff5e8a",
		grid.ActionTempoChange:   "#93c4e6",
	},
}
...
var orangegroveTheme = Theme{
	...
	lineActionColors: map[grid.Action]string{
		...
		grid.ActionSpecificValue: "#e8871e",
		grid.ActionTempoChange:   "#00c8ff",
	},
}
...
var cyberpunkTheme = Theme{
	...
	lineActionColors: map[grid.Action]string{
		...
		grid.ActionSpecificValue: "#05eebb",
		grid.ActionTempoChange:   "#fcee21",
	},
}
...
var brainiacTheme = Theme{
	...
	lineActionColors: map[grid.Action]string{
		...
		grid.ActionSpecificValue: "#aa77cc",
		grid.ActionTempoChange:   "#f8b24b",
	},
}
...
var spaceodysseyTheme = Theme{
	...
	lineActionColors: map[grid.Action]string{
		...
		grid.ActionSpecificValue: "#dd80c0",
		grid.ActionTempoChange:   "#1fcfec",
	},
}
...
var nineteenfiftyeightTheme = Theme{
	...
	lineActionColors: map[grid.Action]string{
		...
		grid.ActionSpecificValue: "#5779e6",
		grid.ActionTempoChange:   "#37f4d6",
	},
}
...
var appleiiplusTheme = Theme{
	...
	lineActionColors: map[grid.Action]string{
		...
		grid.ActionSpecificValue: "#cc33cc",
		grid.ActionTempoChange:   "#7733cc",
	},
}
...
var matrixTheme = Theme{
	...
	lineActionColors: map[grid.Action]string{
		...
		grid.ActionSpecificValue: "#22cc00",
		grid.ActionTempoChange:   "#ffffff",
	},
}
...
var herbieTheme = Theme{
	...
	lineActionColors: map[grid.Action]string{
		...
		grid.ActionSpecificValue: "#2c3e50",
		grid.ActionTempoChange:   "#1b95e0",
	},
}
...
var milesTheme = Theme{
	...
	lineActionColors: map[grid.Action]string{
		...
		grid.ActionSpecificValue: "#2980b9",
		grid.ActionTempoChange:   "#ecf0f1",
	},
}
